function res = SplineCubicaNatural3Puntos(puntos,inc)
T = 0:inc:1;
res = [];
num_tramos = 2;
Dx = inv([2 1 0;1 4 1;0 1 2])*[3.*(puntos(2,1)-puntos(1,1)); 3.*(puntos(3,1)-puntos(1,1)); 3.*(puntos(3,1)-puntos(2,1))];
Dy = inv([2 1 0;1 4 1;0 1 2])*[3.*(puntos(2,2)-puntos(1,2)); 3.*(puntos(3,2)-puntos(1,2)); 3.*(puntos(3,2)-puntos(2,2))];
